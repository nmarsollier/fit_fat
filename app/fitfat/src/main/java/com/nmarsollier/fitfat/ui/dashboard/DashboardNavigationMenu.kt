...
fun DashboardNavigationMenu(
    ...
    BottomNavigation(
        ...
        BottomNavigationItem(icon = {
            Icon(
                painterResource(id = UR.drawable.ic_settings_black_24dp),
        ...
        BottomNavigationItem(icon = {
            Icon(
                painterResource(id = UR.drawable.ic_home_black_24dp),
        ...
        BottomNavigationItem(icon = {
            Icon(
                painterResource(id = UR.drawable.ic_show_chart_black_24dp),
