...
fun OptionsContentDetail(
    ...
    Column(
        Modifier
            .padding(16.dp)
            .background(com.nmarsollier.fitfat.utils.ui.theme.AppColors.background)
        ...
        TextField(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .clickable {
                    com.nmarsollier.fitfat.utils.ui.dialogs.showDatePicker(
                        context,
        ...
        Row(
            ...
            Text(
                ...
                color = com.nmarsollier.fitfat.utils.ui.theme.AppColors.primary
            )
        }
