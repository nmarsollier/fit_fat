...
import com.nmarsollier.fitfat.utils.converters.formatDateTime
...
class DateUtilsTest {
    ...
    @Test
    fun dateOfTest() {
        assertEquals(1697338800000, com.nmarsollier.fitfat.utils.converters.dateOf(2023, 10, 15).time)
    }
}