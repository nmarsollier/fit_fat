package com.nmarsollier.fitfat.measures.ui.measuresList
...
import com.nmarsollier.fitfat.measures.ui.editMeasure.EditMeasureActivity
...
fun MeasuresListContent(
    ...
    Scaffold(topBar = {
        ...
        FloatingActionButton(
            ...
            Icon(
                painterResource(id = UR.drawable.ic_add_black_24dp),
                "",
            )
        }
