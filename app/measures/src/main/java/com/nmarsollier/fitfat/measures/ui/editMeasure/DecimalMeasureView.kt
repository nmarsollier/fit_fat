    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                color = colorResource(id = com.nmarsollier.fitfat.utils.R.color.colorPrimary)
            )
            Text(unit)
            Spacer(Modifier.weight(1f))
            Image(painterResource(UR.drawable.ic_help_outline_black_24dp),
                "",
                colorFilter = ColorFilter.tint(colorResource(com.nmarsollier.fitfat.utils.R.color.colorPrimary)),
